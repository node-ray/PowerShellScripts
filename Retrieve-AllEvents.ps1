# A PowerShell script salvaged from the now-retired Microsoft TechNet Repository.
# It prompts for a date/time range, auto-selecting the past hour, and outputs the results to a CSV file. Admin permissions required
...
$ExportToCsv=$True
$ExportToCSVPath="c:\temp\EventLogs" # Provide a local or UNC path where to store the CSV file. 
