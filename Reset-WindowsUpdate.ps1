# A PowerShell script salvaged from the now-retired Microsoft TechNet Repository. Makes a best-effort attempt to repair windows updates. 
# Appears to have been originally designed for Server 2012 (see lines 107-110), but may work for newer/older OS versions (take a snapshot first)
